...
public class ProductPropertyServiceImpl implements ProductPropertyService {
    ...
    public void add(ProductProperty productProperty, String operationType) {
        ...
        rabbitMQSender.send(queue, "{\"event_type\": \"add\", \"data_type\": \"product_property\", " +
    ...
    public void update(ProductProperty productProperty, String operationType) {
        ...
        rabbitMQSender.send(queue, "{\"event_type\": \"update\", \"data_type\": \"product_property\", " +
                "\"id\": " + productProperty.getId() + ", \"product_id\":" + productProperty.getProductId() + "}");
    }
    ...
    public void delete(Long id, String operationType) {
        ...
        rabbitMQSender.send(queue, "{\"event_type\": \"delete\", \"data_type\": \"product_property\", " +
                "\"id\": " + productProperty.getId() + ", \"product_id\":" + productProperty.getProductId() + "}");
    }
